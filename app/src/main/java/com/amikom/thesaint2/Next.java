    ...
    class CheckConnectionStatus extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                ArrayList<NextDetails> nextList = new ArrayList<>();
                ...
                for (int i=0; i<jsonArray.length();i++)
                {
                    ...
                    NextDetails nextDetails = new NextDetails();
                ...
                NextArrayAdapter nextArrayAdapter = new NextArrayAdapter(Next.this, R.layout.next_daftar,nextList);
