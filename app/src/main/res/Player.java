    ...
    class CheckConnectionStatus extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                ArrayList<com.amikom.thesaint.PlayerDetails> playerList = new ArrayList<>();
                ...
                for (int i=0; i<jsonArray.length();i++)
                {
                    ...
                    com.amikom.thesaint.PlayerDetails playerDetails = new com.amikom.thesaint.PlayerDetails();
                ...
                PlayerArrayAdapter playerArrayAdapter = new PlayerArrayAdapter(com.amikom.thesaint.Player.this, R.layout.player_daftar,playerList);
